    ...
    <div class="fs-job">
        <div class="row mb-3 head-banner p-2 flex align-items-center justify-content-center">
            ...
            <div class="col-8 pe-3">
                <div class="form-group has-search">
                    ...
                    <?php
                    $query = "SELECT keywords FROM job_post where company_id={$_GET['company_id']} ORDER BY id DESC";
        ...
        <div class="container" style="margin-bottom: 105px">
            ...
            <div class="row text-center mt-3" style="margin: 0 25px;">
                <div class="col-3">
                    <a href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Full-Time">
                        <img class="icons" alt="" src="assets/images/12/3.webp"/>
                    </a>
                </div>
                <div class="col-3">
                    <a href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Part-Time">
                        <img class="icons" alt="" src="assets/images/12/4.webp"/>
                    </a>
                </div>
                <div class="col-3">
                    <a href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Freelance">
                        <img class="icons" alt="" src="assets/images/12/2.webp"/>
                    </a>
                </div>
                <div class="col-3">
                    <a href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Project-Based">
            ...
            <div class="row text-center" style="margin: 0 25px;">
                <div class="col-3">
                    <a class="text-decoration-none" href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Full-Time">
                        <p class="icon-text text-dark">Full-Time</p>
                    </a>
                </div>
                <div class="col-3">
                    <a class="text-decoration-none" href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Part-Time">
                        <p class="icon-text text-dark">Part-Time</p>
                    </a>
                </div>
                <div class="col-3">
                    <a class="text-decoration-none" href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Freelance">
                        <p class="icon-text text-dark">Freelance</p>
                    </a>
                </div>
                <div class="col-3">
                    <a class="text-decoration-none" href="company.php?company_id=<?php echo $_GET['company_id']; ?>&job_type=Project-Based">
...
<script>
    ...
    function showTask(val) {
        $.ajax({
            type: 'GET',
            url: 'show_task_company.php',
            data: {keywords: val,company_id:<?php echo $_GET['company_id']; ?>},
