                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-3 ps-2 pe-2">
                                            <input class="form-control fs-form-control" name="one" placeholder=""
                                                   type="text" required>
                                        </div>
                                        <div class="col-3 ps-2 pe-2">
                                            <input class="form-control fs-form-control" name="two" placeholder=""
                                                   type="text" required>
                                        </div>
                                        <div class="col-3 ps-2 pe-2">
                                            <input class="form-control fs-form-control" name="three" placeholder=""
                                                   type="text" required>
                                        </div>
                                        <div class="col-3 ps-2 pe-2">
                                            <input class="form-control fs-form-control" name="four" placeholder=""
                                                   type="text" required>
                                        </div>
                                    </div>
                                </div>
