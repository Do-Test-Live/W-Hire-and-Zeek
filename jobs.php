                ...
                <div class="tab-content">
                    <div aria-labelledby="tab1-tab" class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="row mt-3">
                            <div class="col-6">
                                <div class="card" style="width: 10rem;">
                                    <img alt="" class="card-img-top" src="assets/images/demo-2/11.webp">
                                    <div class="card-body" style="background: #1e3932;">
                                        <p class="card-text card-sub-heading">Magnus</p>
                            ...
                            <div class="col-6">
                                <div class="card" style="width: 10rem;">
                                    <img alt="" class="card-img-top" src="assets/images/demo-2/33.webp">
                                    <div class="card-body" style="background: #1e3932;">
                                        <p class="card-text card-sub-heading">Programmantis</p>
                                        <h5 class="card-title card-heading">Task Title</h5>
                                        <p class="card-text"><small class="text-muted">$50 HKD/hr</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                <div class="card" style="width: 10rem;">
                                    <img alt="" class="card-img-top" src="assets/images/demo-2/22.webp">
                                    <div class="card-body" style="background: #1e3932;">
                                        <p class="card-text card-sub-heading">Programmantis</p>
                                        <h5 class="card-title card-heading">Task Title</h5>
                                        <p class="card-text"><small class="text-muted">$50 HKD/hr</small></p>
